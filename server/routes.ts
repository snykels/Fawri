...
### الوصف الطويل المفصل (200-500 كلمة):
- المواصفات التفصيلية: الأبعاد، الوزن، المعالج، معالج الرسومات، منفذ الشحن، السرعة
- محتويات العلبة: الجهاز، الشاحن، الكابل، دليل المستخدم
- نسخة الشرق الأوسط
